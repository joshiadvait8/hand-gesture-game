...
const int trigPin2 = 6; //6 // the number of the trigger output pin ( sensor 2 ) 
const int echoPin2 = 5;  //5// the number of the echo input pin ( sensor 2 ) 
...
void loop()
{
  ...
  { 
    ...
    while(distance1<=20 && distance1>=5) // this loop will rotate untill we removes our hand infront of the left sensor. this will avoid not to enter this if condition again.
    find_distance();                      
    }
